...
public class TileSet extends CommonFixture {
    ...
    /**
     * Partly addresses Requirement 24 /req/tileset/tmxslink
    ...
    public void validateTilesetResponse( TestPoint testPoint ) {
		...
		String[] knownTMS = {"WebMercatorQuad","WorldCRS84Quad","WorldMercatorWGS84Quad","UTM31WGS84Quad","UPSArcticWGS84Quad","UPSAntarcticWGS84Quad","EuropeanETRS89_LAEAQuad","CanadianNAD83_LCC","GNOSISGlobalGrid"};
